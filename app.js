    ...
    '<div class="schedule-shell">',
      ...
      '<div class="schedule-meta">',
        ...
        '<div class="schedule-meta-actions">',
          '<button class="btn social-btn" style="--social-open-width:132px;" onclick="loadFacultySchedule(true)" title="Оновити"><span class="social-ico">&#8635;</span><span class="social-label">Оновити</span></button>',
          '<a class="btn social-btn" style="--social-open-width:164px;" href="https://rasp.kart.edu.ua/faculty" target="_blank" rel="noopener" title="Сайт універу"><span class="social-ico">&#8599;</span><span class="social-label">Сайт універу</span></a>',
        '</div>',
      '</div>',
